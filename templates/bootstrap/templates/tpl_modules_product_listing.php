...
<br class="clearBoth">
<div id="productsListingListingTopLinks" class="navSplitPagesLinks pagination"><ul><?php echo TEXT_RESULT_PAGE . ' ' . $listing_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></ul></div>
<br class="clearBoth" />
<?php
}
?>
...
<br class="clearBoth">
<div  id="productsListingListingBottomLinks" class="navSplitPagesLinks pagination"><ul><?php echo TEXT_RESULT_PAGE . ' ' . $listing_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></ul></div>
<br class="clearBoth" />
<?php
  }
?>

...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="http://www.samuelsena.com" target="_blank">Samuel Sena</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
